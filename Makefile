...
SRCS_DIR	=	./
OBJS_DIR	=	objs
SRCS			= builtins/env.c builtins/export_no_args.c builtins/export.c builtins/pwd.c builtins/unset.c error.c free.c lexer_from_zero.c lexer_list.c lexer_test.c main.c shell_env.c test.c utils.c expand.c signal.c
