...
SRCS_DIR	=	./
OBJS_DIR	=	objs
SRCS			= builtins/env.c builtins/export_no_args.c builtins/export.c builtins/pwd.c builtins/unset.c builtins/cd.c error.c exec_from_zero.c free.c lexer_from_zero.c lexer_list.c lexer_test.c main.c parser.c shell_env.c test.c utils.c expand.c
